    ...
    <div class="grid grid-cols-12 gap-0">
        <div class="col-span-full md:col-span-4 bg-white relative">
            <div class="absolute inset-y-0 right-0">
                <div class="w-24 bg-white h-auto md:h-[33rem] flex flex-col justify-between items-center border-l relative">
                    ...
                    <div class="w-full h-auto flex flex-col">
                        <div class="flex w-full overflow-hidden bg-gray-100 my-0 border-t" on:click={() => toggleMap()}>
                            <div class="flex items-center justify-center w-full py-4 cursor-pointer">
                                <svg class="bi bi-compass w-6 h-6 text-gray-900 fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div class="flex w-full overflow-hidden bg-gray-100 my-0 border-t" on:click={() => toggleWeather()}>
                            <div class="flex items-center justify-center w-full py-4 cursor-pointer">
                                <svg class="bi bi-cloud-drizzle w-6 h-6 text-gray-900 fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M4.158 12.025a.5.5 0 0 1 .316.633l-.5 1.5a.5.5 0 0 1-.948-.316l.5-1.5a.5.5 0 0 1 .632-.317zm6 0a.5.5 0 0 1 .316.633l-.5 1.5a.5.5 0 0 1-.948-.316l.5-1.5a.5.5 0 0 1 .632-.317zm-3.5 1.5a.5.5 0 0 1 .316.633l-.5 1.5a.5.5 0 0 1-.948-.316l.5-1.5a.5.5 0 0 1 .632-.317zm6 0a.5.5 0 0 1 .316.633l-.5 1.5a.5.5 0 1 1-.948-.316l.5-1.5a.5.5 0 0 1 .632-.317zm.747-8.498a5.001 5.001 0 0 0-9.499-1.004A3.5 3.5 0 1 0 3.5 11H13a3 3 0 0 0 .405-5.973zM8.5 2a4 4 0 0 1 3.976 3.555.5.5 0 0 0 .5.445H13a2 2 0 0 1 0 4H3.5a2.5 2.5 0 1 1 .605-4.926.5.5 0 0 0 .596-.329A4.002 4.002 0 0 1 8.5 2z"/>
                                </svg>
                            </div>
                        </div>
                        
                        <div class="flex w-full overflow-hidden bg-gray-100 my-0 border-t" on:click={() => toggleHome()}>
                            <div class="flex items-center justify-center w-full py-4 cursor-pointer">
                                <svg class="bi bi-app-indicator w-6 h-6 text-gray-900 fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="col-span-full md:col-span-8 relative">
                ...
                <div class="flex flex-col justify-center items-center w-full">
                    ...
                    >
                        <div class="flex flex-col">
                            <h2 class="font-bold align-middle text-gray-800 dark:text-gray-200">
                                Google Map
                            </h2>
                            <small class="text-gray-700">Your Target Location on Island</small>
                        </div>
                        ...
                        <button
                            ...
                            class="m-2 w-full inline-flex justify-center shadow-sm px-5 py-3 bg-gray-100 text-base font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 dark:focus:ring-gray-400 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm capitalize"
                        >
                            <svg
            ...
            <div class="container w-full h-auto md:h-[33rem] mx-auto flex flex-col justify-end md:justify-center items-end md:items-center">
                ...
                <button class="flex w-full max-w-sm mx-auto overflow-hidden bg-white hover:bg-gray-100 rounded-lg border border-green-500 shadow-md my-2" on:click={() => signInGoogleWithPopup()}>
                    ...
                    <div class="px-4 py-2 -mx-3">
                        <div class="mx-3 text-left">
                            ...
                            <p class="text-sm text-gray-700">Autentication with google account</p>
                        </div>
                    </div>
                </button>

                <button class="flex w-full max-w-sm mx-auto overflow-hidden bg-white hover:bg-gray-100 rounded-lg shadow-md my-2">
                    <div class="flex items-center justify-center h-16 w-16 border-r">
                        <svg class="bi bi-facebook w-6 h-6 text-gray-900 fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div class="px-4 py-2 -mx-3">
                        <div class="mx-3 text-left">
                            ...
                            <p class="text-sm text-gray-700">Autentication with facebook account</p>
                        </div>
                    </div>
                </button>
                ...
                <button class="flex w-full max-w-sm mx-auto overflow-hidden bg-white hover:bg-gray-100 rounded-lg shadow-md my-2">
                    <div class="flex items-center justify-center h-16 w-16 border-r">
                        <svg class="bi bi-github w-6 h-6 text-gray-900 fill-current" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div class="px-4 py-2 -mx-3">
                        <div class="mx-3 text-left">
                            ...
                            <p class="text-sm text-gray-700">Autentication with github account</p>
                        </div>
                    </div>
                </button>
