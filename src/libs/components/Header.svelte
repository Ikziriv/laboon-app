    ...
    <div class="flex flex-col md:flex-row justify-between px-4 md:px-8">
        <div class="flex justify-center py-4 md:py-6">
            <a sveltekit:prefetch href="/" class="flex">
                <span class="font-bold text-2xl tracking-widest mr-2 text-blue-500">Laboon</span>
                <span class="py-1">
        ...
        <div class="flex flex-row justify-between md:justify-center py-4 md:py-6">
            ...
            <div class="ml-4">
                ...
                >
                    {#if $modeStore === true}
                        <SunIcon classes="fill-current text-white w-2 h-2" />
                    {:else}
                        <MoonIcon classes="fill-current text-white w-2 h-2" />
                    {/if}
                </button>
            </div>
        </div>
